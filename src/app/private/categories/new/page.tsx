    ...
    <div className="min-h-screen bg-gradient-to-br from-cyan-50 via-teal-50 to-blue-50">
      <div className="container mx-auto p-6">
        <div className="mb-6">
          ...
          <h1 className="text-3xl font-bold bg-gradient-to-r from-cyan-700 to-teal-600 bg-clip-text text-transparent mt-4">Nueva Categoría</h1>
          <p className="text-cyan-600/80 mt-1">Crea una nueva categoría para organizar tus productos</p>
        </div>
